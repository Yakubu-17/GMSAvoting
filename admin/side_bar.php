<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:green;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style = "color:white;"><i class = "fa fa-home fa-large" > </i>GMSA-KNUST Online Voting System</a>
            ...
            <div class="navbar-default sidebar" role="navigation" >
                <div class="sidebar-nav navbar-collapse" >
                    <ul class="nav" id="side-menu" style="color:green;">
                        ...
                        <li>
                            <a href="canvassing.php"><i class="fa fa-download fa-fw" ></i>Election Results</a>
                        </li>
