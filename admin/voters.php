    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<a  href = "update_status.php"class = "btn btn-success btn-outline pull-right" style = "margin-right:12px;" name = "go"><i class = "fa fa-asterisk fa-spin"></i> Activate All Voters Account</a>
